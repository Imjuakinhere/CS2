...
int main()
{
	...
	//Begin our text-based adventure game
	world.setPlayerLocation("Inn at the Crossroads");
	...
	while (true) //Or you die, or whatever..
	{
		...
		//For example, if the player is at Lannisport, then it would say: Go from: Lannisport to Inn at the Crossroads to King's Landing
		//It must compute the SHORTEST possible route from wherever the player is currently at.
		cout << "Fastes path: ";
